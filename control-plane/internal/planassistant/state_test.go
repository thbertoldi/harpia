...
// DeriveConfigurationState will prompt for them. Templates that declare no such parameters
...
func TestDeriveConfigurationState_BindingMatrix_WhenTemplateDeclaresNoPolicies(t *testing.T) {
	...
	got := planassistant.DeriveConfigurationState(mkTemplate("a"), cfg)
...
func TestDeriveConfigurationState_BindingMatrix_WhenOnlyDeclaredPolicySet(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
		Status:         plansv1.PlanConfigurationStatus_PLAN_CONFIGURATION_STATUS_DRAFT,
		SlotBindings:   []*plansv1.SlotBinding{{StepKey: "a", ExecutorInstallationId: "inst-a"}},
	...
	got := planassistant.DeriveConfigurationState(tpl, cfg)
	if got.Kind != planassistant.StateBindingMatrix {
		t.Fatalf("got %+v, want BINDING_MATRIX (only declared policy is set)", got)
	}
}

func TestDeriveConfigurationState_AwaitingTemplate_WhenTemplateIdEmpty(t *testing.T) {
	got := planassistant.DeriveConfigurationState(mkTemplate("a"), &plansv1.PlanConfiguration{})
	if got.Kind != planassistant.StateAwaitingTemplate {
		t.Fatalf("got %v, want AWAITING_TEMPLATE", got.Kind)
	}
}

func TestDeriveConfigurationState_BindingStep_WhenStepUnbound(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
		Status:         plansv1.PlanConfigurationStatus_PLAN_CONFIGURATION_STATUS_DRAFT,
		SlotBindings:   []*plansv1.SlotBinding{{StepKey: "a", ExecutorInstallationId: "inst-a"}},
	...
	got := planassistant.DeriveConfigurationState(mkTemplate("a", "b"), cfg)
...
func TestDeriveConfigurationState_PoliciesStep_WhenPoliciesUnset(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
		Status:         plansv1.PlanConfigurationStatus_PLAN_CONFIGURATION_STATUS_DRAFT,
		SlotBindings:   []*plansv1.SlotBinding{{StepKey: "a", ExecutorInstallationId: "inst-a"}},
...
func TestDeriveConfigurationState_PoliciesStep_WhenPoliciesPartial(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
		Status:         plansv1.PlanConfigurationStatus_PLAN_CONFIGURATION_STATUS_DRAFT,
		SlotBindings:   []*plansv1.SlotBinding{{StepKey: "a", ExecutorInstallationId: "inst-a"}},
...
func TestDeriveConfigurationState_BindingMatrix_WhenAllStepsBoundAndStatusStillDraft(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId:   "tpl-1",
		Status:           plansv1.PlanConfigurationStatus_PLAN_CONFIGURATION_STATUS_DRAFT,
		SlotBindings:     []*plansv1.SlotBinding{{StepKey: "a", ExecutorInstallationId: "inst-a"}},
...
func TestDeriveConfigurationState_OverseerStep_WhenAgentStepMissingOverseer(t *testing.T) {
...
func TestDeriveConfigurationState_OverseerStep_SkipsBoundAndIntegrationSteps(t *testing.T) {
...
func TestDeriveConfigurationState_BindingMatrix_WhenRequiredOverseersBound(t *testing.T) {
	tpl := mkTemplate("fetch-news", "write-draft")
	markStepIntegration(tpl, "fetch-news")
	markStepAgent(tpl, "write-draft")
	cfg := &plansv1.PlanConfiguration{
...
func TestDeriveConfigurationState_PoliciesStep_WhenRequiredOverseersBoundButPoliciesMissing(t *testing.T) {
	tpl := mkTemplate("fetch-news", "write-draft")
	markStepIntegration(tpl, "fetch-news")
	markStepAgent(tpl, "write-draft")
...
func TestDeriveConfigurationState_Empty_WhenStatusRunnable(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
	...
	got := planassistant.DeriveConfigurationState(mkTemplate("a"), cfg)
	if got.Kind != "" {
		t.Fatalf("got %+v, want no configuration state after DRAFT", got)
	}
}

func TestDeriveConfigurationState_Empty_WhenStatusScheduled(t *testing.T) {
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId: "tpl-1",
...
// excluded step).
func TestDeriveConfigurationState_BindingMatrix_WhenOptionalCapabilityStepOptedOut(t *testing.T) {
...
func TestDeriveConfigurationState_BindingMatrix_WhenImageAndCarouselAreOptedOut(t *testing.T) {
	...
	if got := planassistant.DeriveConfigurationState(tpl, cfg); got.Kind != planassistant.StateBindingMatrix {
...
func TestDeriveConfigurationState_BindingStep_WhenOptionalCapabilityIncluded(t *testing.T) {
	tpl := mkTemplate("write-draft", "generate-image")
	markStepOptionalCapabilities(tpl, "generate-image", "image-generation")
	cfg := &plansv1.PlanConfiguration{
		PlanTemplateId:               "tpl-1",
...
func TestDeriveConfigurationState_BindingMatrix_WhenOptedOutAgentStepNeedsNoOverseer(t *testing.T) {
	tpl := mkTemplate("write-draft", "generate-image")
	markStepAgent(tpl, "write-draft")
