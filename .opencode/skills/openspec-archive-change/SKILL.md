...
4. **Assess delta spec sync state**
   ...
   **Prompt options:**
   ...
   If user chooses sync, use Task tool (subagent_type: "implementer", prompt: "Use Skill tool to invoke openspec-sync-specs for change '<name>'. Delta spec analysis: <include the analyzed delta spec summary>"). Proceed to archive regardless of choice.
